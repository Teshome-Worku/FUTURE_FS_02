    ...
    `}>
      ...
      <div className="border-t border-gray-800 px-4 py-3 space-y-1">
        ...
        <button
          ...
          className="cursor-pointer flex w-full items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-gray-300 transition-all duration-150 hover:bg-red-500/10 hover:text-red-400 active:scale-95"
        >
